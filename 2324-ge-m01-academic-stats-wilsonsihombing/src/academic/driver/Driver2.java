    ...
    public static void main(String[] _args) {
        ...
        while(true){
            ...
            if(tokens[0].equals("student-add")){
                ...
                //System.out.println(String.format("%.2f", total_seluruh));
                
                // for(Student student : students ){
                //     student.Setgpa(total_seluruh);
                //     student.Setsks(total_sks);
                //     System.out.println(student.getId() + "|" + student.getName() + "|" + student.getAddress() + "|" + student.getProdi() + "|" + (String.format("%.2f", student.getGPA()) + "|" + student.getsks()));
                // }
                ...
                //             if(enr.getStatus().equals("None")){
                //                 for(Student student : students){
                //                 if(student.getId().equals(id_std)){
                //                     System.out.println(student.getId() + "|" + student.getName() + "|" + student.getAddress() + "|" + student.getProdi() + "|" + (String.format("%.2f", total_seluruh1) + "|" + total_sks));
                //                 }
                //                 }
                //             }else{
                //             for(Student student : students){
                //                 if(student.getId().equals(id_std)){
                //                     System.out.println(student.getId() + "|" + student.getName() + "|" + student.getAddress() + "|" + student.getProdi() + "|" + (String.format("%.2f", total_seluruh) + "|" + total_sks));
                //                 }
                //             }
                //         }
                //         }
